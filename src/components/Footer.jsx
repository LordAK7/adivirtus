...
const Footer = () => {
  ...
  return (
    <footer ref={ref} className="py-4 bg-black">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          {/* Company Logo and Made with Passion */}
          <motion.div
            variants={linkVariants}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
          ...
          >
            <img src="/logowhite.svg" alt="Company Logo" className="h-6" />
            <span className="text-gray-400 text-sm">
              Made with passion and intellectuality
            </span>
          </motion.div>
        </div>
      </div>
